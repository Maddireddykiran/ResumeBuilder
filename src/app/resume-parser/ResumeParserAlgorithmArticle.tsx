    ...
    ...lines.map((line, idx) => [
      ...
      line.map((item, idx) => (
        <span key={idx}>
          {item.text}
          {idx !== line.length - 1 && (
            <span className="select-none font-extrabold text-[#57CDA4]">
              &nbsp;&nbsp;{"|"}&nbsp;&nbsp;
            </span>
          )}
        </span>
  ...
  return (
    <article className="mt-10">
      ...
      <Paragraph smallMarginTop={true}>
        For the technical curious, this section will dive into the MKR
      ...
      <Paragraph>
        And that is everything about the MKR parser algorithm :)
      </Paragraph>
      <Paragraph>
