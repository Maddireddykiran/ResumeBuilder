...
export const ResumePDFBulletList = ({
  ...
  const validItems = Array.isArray(items) ? items.filter(item => typeof item === 'string') : [];
...
export const ResumeFeaturedSkill = ({
  ...
  // We'll use the box style for all skills now
  return (
    <SkillBox skill={skill} themeColor={themeColor} style={style} />
  );
};

// New component for box-style skills display
export const SkillBox = ({
  ...
  return (
    ...
    >
      <ResumePDFText style={{ fontSize: 9, color: "#444" }}>
        {skill}
      </ResumePDFText>
    </View>
  );
